...
shutdown -r +3
    runner
        ...
        paste resulting_dataframe.csv to_past_*.csv > tmp; mv tmp resulting_dataframe.csv ## append new column to res df
        rm $i
shutdown -c
