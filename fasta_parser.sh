...
#xmfa="/media/daria_der/linuxdata/neisseria_phylogeny/aniA_norB_fhBp/genes_ania_norB_fhBp.xmfa"
xmfa="/media/daria_der/linuxdata/Pneumococcus/Data/XGBOOST_in/BIGSdb_019003_1587496140_15568_core.xmfa"
rm "$xmfa"_edited "$xmfa"_translated
sed 's/-//g' $xmfa| sed 's/ + /___/g'|sed 's/\//_/g'| sed 's/:/_/g' > "$xmfa"_edited

/home/daria_der/Downloads/Soft/faTrans "$xmfa"_edited "$xmfa"_translated
file="$xmfa"_translated
expected_number_of_samples="496"
